...
-   `ItemTypeArmorEmblemCoatingEnabled`
-   `ItemTypeArmorEmblemEnabled`
-   `ItemTypeArmorFxEnabled`
-   `ItemTypeArmorMythicFxEnabled`
-   `ItemTypeVehicleAltGeoEnabled`
-   `ItemTypeVehicleEmblemCoatingEnabled`
-   `ItemTypeVehicleEmblemEnabled`
-   `ItemTypeWeaponAltGeoEnabled`
-   `ItemTypeWeaponCharmGeoEnabled`
-   `ItemTypeWeaponDeathFxEnabled`
-   `ItemTypeWeaponEmblemCoatingEnabled`
-   `ItemTypeWeaponEmblemEnabled`
-   `ManageGameEnabled`
-   `matchmaking_uneven_teams_early_exit_enabled`
-   `matchmaking_uneven_teams_participant_changes_enabled`
-   `MissionRestartEnabled`
-   `MultiplayerEnabled`
-   `MultiplayerItems_LimitForFlighting`
-   `ObserverTeamNameOverridesEnabled`
-   `PlayerProfilesEnabled`
-   `PlayerWeaponHitRegistrationTelemetryEnabled`
